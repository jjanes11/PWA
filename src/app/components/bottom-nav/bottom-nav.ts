...
@Component({
  ...
  template: `
    <nav class="jacaona-bottom-nav">
      <div class="jacaona-nav-items">
        ...
        >
          <div class="jacaona-nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
            </svg>
          </div>
          <span class="jacaona-nav-label">Home</span>
        </button>
        
        <button 
          class="jacaona-nav-item" 
          [class.active]="activeTab() === 'workouts'"
          (click)="navigateToTab('workouts')"
        >
          <div class="jacaona-nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <span class="jacaona-nav-label">Workouts</span>
        </button>
        ...
        >
          ...
          <span class="jacaona-nav-label">Analytics</span>
        </button>
        ...
        >
          ...
          <span class="jacaona-nav-label">Profile</span>
        </button>
      </div>
    </nav>
  `,
  styles: [`
    ...
    .jacaona-nav-item:hover {
      color: var(--jacaona-text-secondary);
    }

    .jacaona-nav-item.active {
      color: var(--jacaona-accent-blue);
    }

    .jacaona-nav-center {
      margin: 0 var(--jacaona-space-lg);
    }
    ...
    .jacaona-start-workout {
      ...
      align-items: center;
      justify-content: center;
      color: var(--jacaona-bg-primary);
      transition: all 0.15s ease;
    }

    .jacaona-nav-center:hover .jacaona-start-workout {
...
export class BottomNavComponent {
  ...
  private updateActiveTabFromRoute() {
    ...
    } else if (currentRoute.includes('workouts')) {
