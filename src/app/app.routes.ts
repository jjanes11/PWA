...
export const routes: Routes = [
  ...
  { 
    path: 'exercise/:name', 
    loadComponent: () => import('./components/exercise-detail/exercise-detail').then(m => m.ExerciseDetailComponent)
  },
  { 
    path: 'profile', 
  ...
  { 
    path: 'dev-tools', 
    loadComponent: () => import('./components/dev-tools/dev-tools').then(m => m.DevToolsComponent)
  },
  { 
    path: 'workout/:id', 
